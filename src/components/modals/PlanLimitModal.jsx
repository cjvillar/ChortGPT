  ...
  return (
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-card" onClick={e => e.stopPropagation()}>
        ...
        <p>You've used all 3 messages on the <strong>Broke Boi Plan</strong>. Upgrade to keep the chort going.</p>
        <div className="plan-compare">
          <div className="plan-compare-label">Plan comparison</div>
          <div className="plan-row"><span>Broke Boi Plan</span><span>3 messages</span></div>
